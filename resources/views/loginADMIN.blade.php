                                ...
                                <div class="card" data-background="color" data-color="blue">
                                    ...
                                    <div class="card-content">
                                        <div class="form-group">
                                            <label>Email </label>
                                            <input type="email" name="emailDangNhap" placeholder="Enter email" class="form-control input-no-border">
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <input type="password" name="mat-khau" placeholder="Password" class="form-control input-no-border">
                                        </div>
                                    </div>
